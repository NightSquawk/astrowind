...
function extractUTMParams(
  url: URL
): Partial<Pick<RedirectEventParams, 'utm_source' | 'utm_medium' | 'utm_campaign' | 'utm_term' | 'utm_content'>> {
  const params: Partial<
    Pick<RedirectEventParams, 'utm_source' | 'utm_medium' | 'utm_campaign' | 'utm_term' | 'utm_content'>
  > = {};
