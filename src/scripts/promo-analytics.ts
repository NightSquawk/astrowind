 ...
 */
export function trackCouponCopied(params: { couponCode: string; couponSlug?: string }): void {
  if (isDevelopment()) {
 ...
 */
export function trackCampaignViewed(params: { campaignId: string; campaignSlug: string }): void {
  if (isDevelopment()) {
 ...
 */
export function trackCampaignClicked(params: { campaignId: string; campaignSlug: string; source?: string }): void {
  if (isDevelopment()) {
