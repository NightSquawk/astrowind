 ...
 */
export function trackGTMEvent(eventName: string, category: string, label?: string, value?: number) {
 ...
 */
export function trackButtonClick(buttonText: string, buttonLocation?: string, buttonUrl?: string) {
 ...
 */
export function trackVideoInteraction(action: string, videoTitle: string, videoUrl?: string, videoProgress?: number) {
