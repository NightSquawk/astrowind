...
import { Navigation, Pagination, Keyboard, Zoom, FreeMode, A11y } from 'swiper/modules';
 ...
 */
function trackGalleryEvent(action: string, imageIndex: number, galleryId: string, totalImages: number) {
  const isDevelopment =
