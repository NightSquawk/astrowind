...
<MuxVideoPlayer playbackId="your-playback-id" metadata={{ video_title: 'My Video' }} aspectRatio="16:9" />
```
...
<MuxAudioPlayer playbackId="your-playback-id" title="Episode 1" artist="Podcast Name" />
```
...
<MuxThumbnail playbackId="your-playback-id" time={10} width={640} alt="Video thumbnail" />
```
